...
class Translator(QWidget):
    ...
    def init_ui(self):
        ...
        bahasa = ["Arabic", "English", "French", "Indonesian", "Japanese", "Spanish"]
        self.combo.addItems(bahasa)
        self.combo.setEditable(True)
        self.combo.lineEdit().setAlignment(Qt.AlignCenter)
        vb.addWidget(self.combo)
        self.target = {"Arabic":"ar", "English":"en", "French":"fr", "Indonesian":"id", "Japanese":"ja", "Spanish":"es"}
...
def main():
        ...
        gui.setWindowTitle("Machine Translation 1.0")
        gui.show()
        sys.exit(app.exec_())
